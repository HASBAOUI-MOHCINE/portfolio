  ...
  const handleChange = (e) => {
    ...
    switch (name) {
      ...
      case 'phone':
        ...
        break;
      case 'message':
        // Basic message sanitization - remove script tags and other potentially harmful content
  ...
  return (
    <section id="contact" className="pt-24 pb-16 px-6">
      ...
      <div className="max-w-xl mx-auto bg-gray-800/50 backdrop-blur-sm rounded-xl shadow-lg border border-gray-700/50 p-8">
        <div className="text-6xl text-purple-500 mb-4 text-center">
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-center gap-6 text-gray-400">
          <div><i className="fas fa-user mr-2"></i> Mohcine Hasbaoui</div>
          <div><i className="fas fa-phone mr-2"></i> +212 622 664410</div>
        </div>
      </div>
    </section>
  );
